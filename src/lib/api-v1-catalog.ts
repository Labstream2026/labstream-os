...
export const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  { method: "POST", path: "/api/v1/tasks", group: "Tareas", summary: "Crea una tarea personal/suelta (sin proyecto) y la asigna a alguien del equipo (aparece en su «Mis tareas» con aviso app+correo).", permission: "crear_tareas", write: true, body: [{ name: "title", required: true, type: "string" }, { name: "description", type: "string" }, { name: "assigneeId", type: "string", desc: "persona del equipo; por defecto el titular" }, { name: "priority", type: "string" }, { name: "startDate", type: "string", desc: "YYYY-MM-DD" }, { name: "dueDate", type: "string", desc: "YYYY-MM-DD" }, { name: "dueTime", type: "string", desc: "HH:mm" }, { name: "isPrivate", type: "boolean" }] },
  { method: "POST", path: "/api/v1/tasks/quick", group: "Tareas", summary: "Crea una tarea desde UNA frase en español: fechas («mañana 9am», «el viernes»), @responsable, #etiquetas, !prioridad y estimación (2h/30m) salen del texto. Ideal para dictar por chat o voz.", permission: "crear_tareas", write: true, body: [{ name: "text", required: true, type: "string", desc: "p. ej. «Grabar dron mañana 9am @Zahid #rodaje 2h»" }, { name: "projectId", type: "string", desc: "opcional: la tarea nace en ese proyecto" }] },
  ...
  // ── Recordatorios (herramienta interna del equipo; suenan por la campana y Marcebot/WhatsApp) ──
  { method: "GET", path: "/api/v1/reminders", group: "Recordatorios", summary: "Recordatorios del titular (destinatario o creador), próximos primero.", params: [{ name: "scope", in: "query", desc: "active | paused | all" }, { name: "for", in: "query", desc: "me | userId (otro userId: solo admin)" }, { name: "take", in: "query" }] },
  { method: "POST", path: "/api/v1/reminders", group: "Recordatorios", summary: "Crea un recordatorio (para uno mismo o para un compañero, que recibe aviso).", write: true, body: [{ name: "title", required: true, type: "string" }, { name: "notes", type: "string" }, { name: "forUserId", type: "string", desc: "por defecto el titular" }, { name: "taskId", type: "string" }, { name: "frequency", required: true, type: "string", desc: "UNA_VEZ | DIARIO | SEMANAL | MENSUAL" }, { name: "date", type: "string", desc: "YYYY-MM-DD (solo UNA_VEZ)" }, { name: "timeOfDay", required: true, type: "string", desc: "HH:mm hora de Bogotá" }, { name: "weekdays", type: "number[]", desc: "0=domingo … 6=sábado (solo SEMANAL)" }, { name: "dayOfMonth", type: "number", desc: "1..31 (solo MENSUAL)" }] },
  { method: "GET", path: "/api/v1/reminders/{id}", group: "Recordatorios", summary: "Detalle del recordatorio.", params: [{ name: "id", in: "path", required: true }] },
  { method: "PATCH", path: "/api/v1/reminders/{id}", group: "Recordatorios", summary: "Edita, pausa/reactiva, pospone (snooze) o reprograma el recordatorio.", write: true, params: [{ name: "id", in: "path", required: true }], body: [{ name: "title", type: "string" }, { name: "notes", type: "string" }, { name: "active", type: "boolean" }, { name: "snooze", type: "string", desc: "10m | 1h | manana" }, { name: "frequency", type: "string" }, { name: "date", type: "string", desc: "YYYY-MM-DD (UNA_VEZ)" }, { name: "timeOfDay", type: "string" }, { name: "weekdays", type: "number[]" }, { name: "dayOfMonth", type: "number" }] },
  { method: "DELETE", path: "/api/v1/reminders/{id}", group: "Recordatorios", summary: "Elimina el recordatorio (creador, destinatario o admin).", write: true, params: [{ name: "id", in: "path", required: true }] },
